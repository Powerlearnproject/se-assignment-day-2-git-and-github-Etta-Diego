...
>| **Type of Repository**         | **Advantages**                                                                                          | **Disadvantages**                                                                                             |
|-------------------------------|----------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------|
| *Public Repository*            | - *Visibility:* Open to everyone, attracting global contributors.                                         | - *Privacy:* Code and project details are exposed to everyone, which might not suit sensitive projects.        |
|                               | - *Community Engagement:* Easier to gather feedback and contributions from diverse people.                | - *Control:* Less control over contributions, which may cause quality or security issues.                      |
| *Private Repository*           | - *Privacy:* Only selected people can access, keeping sensitive information secure.                      | - *Limited Visibility:* Reduces the opportunity to attract external contributors and public feedback.          |
|                               | - *Control:* More control over who can view and contribute, ensuring better quality and security.         | - *Collaboration:* Limited to invited members, reducing the diversity of input and ideas.                      |
...
```
    ...
    ii  **Creating Remote Branches:** Up to now, we've talked about working with branches on your local machine. But you can also work with branches on remote repositories. Below is how to set that up:
